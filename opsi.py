...
def chk(): 
  ...
  banner()
  print ("\033[1;92m")
  print("\x1b[1;97m [\033[1;91m�\x1b[1;97m]\033[1;93m Linensi Kamu Adalah: "+id) 
  print ("\033[1;92m")
  try: 
    httpCaht = requests.get("https://github.com/Dhanz03/bruteFB/blob/main/user1.txt").text 
    if id in httpCaht: 
      print("\x1b[1;97m [\033[1;92m�\x1b[1;97m]\033[1;97m  LINENSI KAMU SUDAH AKTIF BOS GAS CRACK........\033[97m") 
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass     
    else: 
      print("\x1b[1;97m [\033[1;91m�\x1b[1;97m]\033[1;93m LINENSI KAMU TIDAK AKTIF | AKTIFKAN CHAT WA BANH Dhanz\033[97m")
      os.system('xdg-open https://wa.me/6285881856121?text=Bang+AktifinID+ScPrem+10k-5Hari+20k-2Minggu+5k-2Hari+nya+dong')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def menu(my_name,my_id):
	...
	print(f'\033[93m☞ Idz Facebook : '+str(my_id))
	print(f'\33[1;96m☞ Ip Android : {ip}')
	print("""
	
%s{%s01%s} Crack Publik 
%s{%s02%s} Cek Opsi Tapyes 
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\33[1;96m☞ Mau Berapa Target Njing ? : '))
	except ValueError:
...
def setting():
	...
	print('\33[1;96m☞ 3. Random (Recomend) ')
	print('')
	hu = input('☞ Pilih : ')
	if hu in ['1','01']:
		...
		exit()
	print('\x1b[1;92m☞1. Mobile [Recomend] ')
	print('')
	hc = input('☞ Pilih : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\x1b[0;34m☞ Tambahkan Aplikasi ( y/t ) ')
	if _jembot_ in ['']:
		print('☞ Pilih Yang Bener Kontol ')
		back()
		...
		taplikasi.append('y')
	pwplus=input('\33[1;96m☞ Tambahkan Password Manual ( y/t) ')
	if pwplus in ['y','Ya']:
		pwpluss.append('ya')
...
def passwrd():
	...
	print(f'   {B}Mainkan Mode Pesawat Setiap 500 Id Okh{B}')
	print(f'   {K} Crack Jangan Berlebihan Nanti Spam IP {K}')
	print(f'│{h}==========================================={h}│')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [aman] {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
